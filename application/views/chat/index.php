                ...
                <div class="row border" id="cont_enviar_mensaje_chat">
                    <form class="form-inline" id="form_mensaje">
                        <div class="form-group" id="form_enviar_mensaje">
                            ...
                            <textarea class="form-control" id="text_nvo_mensaje" cols="29" name="query"></textarea>
                        </div>
                        <button type="button" onclick="enviar_mensaje()" class="btn btn-primary btn-raised" id="btn_send"><i class="fas fa-share-square"></i> Enviar</button>
                    </form>
                </div>
            </div>
