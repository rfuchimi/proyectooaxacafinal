...
function getAudio(text, flag) {
  ...
  recognition.onend = function() {
    ...
    //watson_text !='' ? getAudio(watson_text,1) : '';
      //respuesta(watson_text);// respuesta de la asistente despues de preguntar
  ...
  recognition.onresult = function(event) {
    ...
    var texto = linebreak(final_transcript);
    console.log(texto);
    var armarTexto= linebreak(interim_transcript);
    $("#text_nvo_mensaje").val(armarTexto);
    $("#text_nvo_mensaje").val(texto);
