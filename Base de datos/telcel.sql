...
-- -----------------------------------------------------
-- Table `telcel`.`Persona`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `telcel`.`Persona` ;

CREATE TABLE IF NOT EXISTS `telcel`.`Persona` (
...
-- Table `telcel`.`Region`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `telcel`.`Region` ;

CREATE TABLE IF NOT EXISTS `telcel`.`Region` (
...
-- Table `telcel`.`Estado`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `telcel`.`Estado` ;

CREATE TABLE IF NOT EXISTS `telcel`.`Estado` (
  ...
  CONSTRAINT `fk_Estado_Region1`
    FOREIGN KEY (`reg_id`)
    REFERENCES `telcel`.`Region` (`reg_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `telcel`.`Municipio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `telcel`.`Municipio` ;

CREATE TABLE IF NOT EXISTS `telcel`.`Municipio` (
  ...
  CONSTRAINT `fk_Municipio_Estado1`
    ...
    REFERENCES `telcel`.`Estado` (`estado_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `telcel`.`Localidad`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `telcel`.`Localidad` ;

CREATE TABLE IF NOT EXISTS `telcel`.`Localidad` (
  ...
  CONSTRAINT `fk_Localidad_Municipio1`
    ...
    REFERENCES `telcel`.`Municipio` (`mun_id` , `estado_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `telcel`.`direccionCliente`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `telcel`.`direccionCliente` ;

CREATE TABLE IF NOT EXISTS `telcel`.`direccionCliente` (
  ...
  CONSTRAINT `fk_direccionCliente_Cliente`
    FOREIGN KEY (`cli_id`)
    REFERENCES `telcel`.`Persona` (`per_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_direccionCliente_Localidad1`
    FOREIGN KEY (`loc_id` , `mun_id` , `estado_id`)
    REFERENCES `telcel`.`Localidad` (`loc_id` , `mun_id` , `estado_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
